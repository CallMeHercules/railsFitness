...
class LiftsControllerTest < ActionController::TestCase
  ...
  test "should create lift" do
    assert_difference('Lift.count') do
      post :create, lift: { date: @lift.date, lift_name: @lift.lift_name, repetitions: @lift.repetitions, weight: @lift.weight }
    end
  ...
  test "should update lift" do
    patch :update, id: @lift, lift: { date: @lift.date, lift_name: @lift.lift_name, repetitions: @lift.repetitions, weight: @lift.weight }
    assert_redirected_to lift_path(assigns(:lift))
  end
